					...
					<swiper
						...
						<swiper-slide class="swiper-slide">
							<div class="list_inner">
								...
								<a class="full_link popup-vimeo" href="//player.vimeo.com/video/321091335?autoplay=1"></a>
							</div>
						</swiper-slide>
						<swiper-slide class="swiper-slide">
							<div class="list_inner">
								...
								<a class="full_link popup-youtube" href="//www.youtube.com/embed/toClS5fCudA?autoplay=1"></a>
							</div>
						</swiper-slide>
						<swiper-slide class="swiper-slide">
							<div class="list_inner">
								...
								<a
									class="full_link soundcloud_link mfp-iframe audio"
							...
							<div class="list_inner">
								...
								<div class="hidden_content">
									<div class="portfolio_popup_details">
										...
										<div class="text">
											<p>
												An apple is an edible fruit produced by an apple tree. Apple trees are cultivated worldwide and
												are the most widely grown species in the genus Malus. The tree originated in Central Asia, where
												its wild ancestor, Malus sieversii, is still found today.
											</p>
											<p>
												Apples grown from seed tend to be very different from those of the parents, and the resultant
												fruit frequently lack desired characteristics. Generally then, apple cultivars are propagated by
												clonal grafting onto rootstocks. Apple trees grown without rootstocks tend to be larger and much
												slower to fruit after planting.
											</p>
										</div>
												...
												<li>
													<div class="list_inner">
														<div class="image">
															...
															<a class="full_link zoom" href="img/portfolio/8.jpg"></a>
														</div>
													</div>
												</li>
												<li>
													<div class="list_inner">
														<div class="image">
															...
															<a class="full_link zoom" href="img/portfolio/9.jpg"></a>
														</div>
													</div>
												</li>
											</ul>
						...
						<div class="swiper_progress fill">
							<div class="my_pagination_in">
								...
								<span class="pagination_progress"
									><span class="all"
										><span style="transform: translate3d(0px, 0px, 0px) scaleX(0.75) scaleY(1)"></span></span
								></span>
...
import { swiperSliderCustomSlider } from '../utilities';
...
const onSlideChange = (swiper) => {
	activeSlider.value = swiper.activeIndex + 1;
};
</script>
